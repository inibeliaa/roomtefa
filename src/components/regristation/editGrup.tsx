...
const EditGrup: React.FC<EditPop> = ({ isVisible, onClose, id }) => {
  ...
  async function getGroupData() {
    ...
    try {
      ...
      setGrup(grup.data)
        if (grup.data) {
          ...
          setAccomodation(grup.data.roomRs || "");
          setRemarks(grup.data.regis || []);
          setArrangements(grup.data.makananRs || []);
          ...
          setEnter(grup.data.front_desk || "");
          setArrival(grup.data.arrivalRegistrasi || "");
          setDeparture(grup.data.departureRegistrasi || "");
    ...
    async function editGroup() {
        const url = `${process.env.NEXT_PUBLIC_URL}api/editRGroup/${id}`;
        try {
        ...
        {grupData && 
         <div style={{ top: window.scrollY }} className="flex-col rounded-[20px]  flex space-y-[2%] w-[100%] min-h-screen">
          ...
          <div className="flex space-x-[20px] w-[100%]">           
            ...
            <div className="w-[50%]">
              <label htmlFor="Phone" className="text-[20px]">Phone</label>
                <input type="text" onChange={(e) => setPhone(e.target.value)} value={phone}  name='Phone' className='bg-white p-2 w-full h-[50px] rounded-md' />
              </div>
              <div className="w-[50%]">
              <label htmlFor="Email" className="text-[20px]">Email</label>
                    <input type="text" onChange={(e)=> setEmail(e.target.value)} value={email} name='Email' className='bg-white p-2 w-full h-[50px] rounded-md' />
              </div>
            </div>
          ...
          <div className='flex space-x-[2%]'>
                    ...
                    <input type="text" value={displayDown || (down ? new Intl.NumberFormat("id-ID", {
                                              style: "currency",
                                              currency: "IDR",
                                              minimumFractionDigits: 0,
                                          }).format(down) : "")} onChange={handleDownChange} name='dp' className='bg-white p-2 w-full h-[50px] rounded-md' />
            </div> 
            <div className='w-[33%]'>
          ...
          <p  className="text-[20px]">Number of Guest</p>
            ...
            <div className="flex-col space-y-[2%] w-[50%]">    
              ...
              {arrival && arrival?.map((data, i) => (            
                  ...
                  <input defaultValue={formatTanggalInput(data.datee)} onChange={(e) => handleChangeFieldArrival(e,i)} id="checkin-date" min={data.datee} max={maxTanggal} type="date" name='datee' className='bg-white p-2 w-full h-[50px] rounded-md' />
              ...
              {departure && departure?.map((item, id) => (
                  ...
                  <label htmlFor="datee" className="text-[20px]">Date</label>
                  <input defaultValue={formatTanggalInput(item.datee)} type="date" onChange={(e) => handleChangeFieldDeparture(e,id)} min={arrival[0]?.datee} max={maxTanggal} id="checkout-date" name='datee' className='bg-white p-2 w-full h-[50px] rounded-md' />
                </div><div className='w-[100%]'>
                    <label htmlFor="flight" className="text-[20px]">Flight</label>
          ...
          <div className="flex">
                ...
                <div className="w-[93%]">
                  ...
                  <div className="flex space-x-[2%] w-[100%]">           
                    ...
                    <div className='w-[50%]'>
                        ...
                        <input type="date" id="date-C" value={formatTanggalInput(dateC)} min={dateC} max={maxTanggal} onChange={(e)=>setdateC(e.target.value)} name='Date' className='bg-white p-2 w-full h-[50px] rounded-md' />
                    </div>
                  </div>
            ...
            <div className='w-[33%] flex flex-col'>
              ...
              <div className="w-[85%]">
                        ...
                        <input type="date" name='Rack Slip' min={initial} max={maxTanggal} value={formatTanggalInput(initial)} onChange={(e)=>setInitial(e.target.value)} className='bg-white p-2 w-full h-[50px] rounded-r-md' />
              </div>
              ...
              <div className="w-[100%]">
                        ...
                        <input type="date" name='Charter Date'  value={formatTanggalInput(charter)} onChange={(e)=>setCharter(e.target.value)} min={charter} max={maxTanggal}className='bg-white p-2 w-full h-[50px] rounded-md' />
              </div>
             
              </div>
                    </div>
                      <div className='w-[33%]'>
                        <label htmlFor="Entered By" className="text-[20px]"> Front Desk Agent</label>
          ...
          <button onClick={editGroup} className='w-[120px] cursor-pointer bg-white shadow-md h-[40px] rounded-lg font-semibold text-[#0E7793] border border-1 text-[20px] border-[#0B6279]'>
                            Submit
          </button>
                  </div>
        }
