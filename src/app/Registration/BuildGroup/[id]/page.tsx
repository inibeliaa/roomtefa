...
async function getGroupData() {
  ...
  async function AddGroup() {
      const url = isValidId ? `${process.env.NEXT_PUBLIC_URL}api/reggroup` : `${process.env.NEXT_PUBLIC_URL}api/registrasiG`;
      try {
          ...
          <p  className="text-[20px]">Number of Guest</p>
            ...
            <div className="flex-col space-y-[2%] w-[50%]">    
              ...
              {arrival && arrival?.map((data, i) => (            
                  ...
                  <input defaultValue={formatTanggalInput(data.datee)} onChange={(e) => handleChangeFieldArrival(e,i)} min={!id ? minTanggal : data.datee}
 max={maxTanggal} type="date" name='datee' className='bg-white p-2 w-full h-[50px] rounded-md' />
                </div>
                  <div className='w-[100%]'>
              ...
              {departure && departure?.map((item, id) => (
                  ...
                  <label htmlFor="datee" className="text-[20px]">Date</label>
                  <input defaultValue={formatTanggalInput(item.datee)} type="date" onChange={(e) => handleChangeFieldDeparture(e,id)} min={!id ? minTanggal : item.datee} max={maxTanggal} id="checkout-date" name='datee' className='bg-white p-2 w-full h-[50px] rounded-md' />
                </div><div className='w-[100%]'>
                    <label htmlFor="flight" className="text-[20px]">Flight</label>
